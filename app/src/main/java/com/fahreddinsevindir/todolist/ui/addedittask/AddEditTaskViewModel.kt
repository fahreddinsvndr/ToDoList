...
import com.fahreddinsevindir.todolist.ui.ADD_TASK_RESULT_OK
import com.fahreddinsevindir.todolist.ui.EDIT_TASK_RESULT_OK
...
class AddEditTaskViewModel @ViewModelInject constructor(
    ...
    fun onSaveClick() {
        ...
        if (task != null) {
            val updatedTask = task.copy(name = taskName, uimportant = taskImportance)
            updatedTask(updatedTask)
        } else {
            val newTask = Task(name = taskName, uimportant = taskImportance)
            createTask(newTask)
        }
    }
